...
public class StarttlsHandlerTest {
    ...
    /**
     * Tests {@code decode} method when successfully establish secure connection via startTls.
     *
     ...
     */
    @Test
    public void testDecodeSuccess() throws IllegalArgumentException, IllegalAccessException, SmtpAsyncClientException {
        final SmtpFuture<SmtpAsyncCreateSessionResponse> smtpFuture = new SmtpFuture<>();
        final SmtpAsyncSessionData sessionData = SmtpAsyncSessionData.newBuilder("smtp.one.two.three.com", 465, true)
        ...
        Mockito.verify(channel, Mockito.times(2)).writeAndFlush(Mockito.isA(ByteBuf.class));
        Assert.assertFalse(smtpFuture.isDone(), "Future shouldn't be done");
    }

    /**
     * Tests {@code decode} method when successful by sending HELO.
     *
     * @throws IllegalAccessException will not throw in this test
     * @throws IllegalArgumentException will not throw in this test
     * @throws SmtpAsyncClientException will not throw in this test
     */
    @Test
    public void testDecodeSuccessHelo() throws IllegalArgumentException, IllegalAccessException, SmtpAsyncClientException {
        final SmtpFuture<SmtpAsyncCreateSessionResponse> smtpFuture = new SmtpFuture<>();
        ...
        Mockito.verify(channel, Mockito.times(3)).writeAndFlush(Mockito.isA(ByteBuf.class));
        Assert.assertFalse(smtpFuture.isDone(), "Future shouldn't be done");
    }

    /**
     * Tests {@code decode} method when failed on bad server greeting.
     *
     * @throws IllegalArgumentException will not throw in this test
     * @throws IllegalAccessException will not throw in this test
     * @throws SmtpAsyncClientException will not throw in this test
     ...
     */
    @Test
    public void testDecodeFailBadServerGreeting()
    ...
    /**
     * Tests {@code decode} method when failed on bad EHLO response and HELO response.
     *
     * @throws IllegalArgumentException will not throw in this test
     * @throws IllegalAccessException will not throw in this test
     * @throws SmtpAsyncClientException will not throw in this test
     ...
     */
    @Test
    public void testDecodeFailBadHeloResponse()
            throws IllegalArgumentException, IllegalAccessException, SmtpAsyncClientException, InterruptedException, TimeoutException {
        final SmtpFuture<SmtpAsyncCreateSessionResponse> smtpFuture = new SmtpFuture<>();
        final SmtpAsyncSessionData sessionData = SmtpAsyncSessionData.newBuilder("smtp.one.two.three.com", 465, true).setSessionContext("myCtx")
                .build();
    ...
    /**
     * Tests {@code decode} method when failed on bad STARTTLS response.
     *
     * @throws IllegalArgumentException will not throw in this test
     * @throws IllegalAccessException will not throw in this test
     * @throws SmtpAsyncClientException will not throw in this test
     ...
     */
    @Test
    public void testDecodeFailBadStarttlsResponse()
            throws IllegalArgumentException, IllegalAccessException, SmtpAsyncClientException, InterruptedException, TimeoutException {
        final SmtpFuture<SmtpAsyncCreateSessionResponse> smtpFuture = new SmtpFuture<>();
        final SmtpAsyncSessionData sessionData = SmtpAsyncSessionData.newBuilder("smtp.one.two.three.com", 465, true).setSessionContext("myCtx")
                .build();
    ...
    /**
     * Tests {@code decode} method when failed on no STARTTLS capability.
     *
     * @throws IllegalArgumentException will not throw in this test
     * @throws IllegalAccessException will not throw in this test
     * @throws SmtpAsyncClientException will not throw in this test
     ...
     */
    @Test
    public void testDecodeFailNoStarttlsCapability()
            throws IllegalArgumentException, IllegalAccessException, SmtpAsyncClientException, InterruptedException, TimeoutException {
        final SmtpFuture<SmtpAsyncCreateSessionResponse> smtpFuture = new SmtpFuture<>();
        final SmtpAsyncSessionData sessionData = SmtpAsyncSessionData.newBuilder("smtp.one.two.three.com", 465, true).setSessionContext("myCtx")
                .build();
     ...
     */
    @Test
    public void testtExceptionCaught() throws InterruptedException, TimeoutException, IllegalArgumentException, IllegalAccessException {
        final SmtpFuture<SmtpAsyncCreateSessionResponse> smtpFuture = new SmtpFuture<>();
        final SmtpAsyncSessionData sessionData = SmtpAsyncSessionData.newBuilder("smtp.one.two.three.com", 465, true).setSessionContext("myCtx")
                .build();
        final Logger logger = Mockito.mock(Logger.class);
    ...
    public void testUserEventTriggeredIdleStateEventReadIdle()
        ...
        Mockito.verify(logger, Mockito.times(1)).error(Mockito.eq(
                "[{},{}] Starttls Connection failed due to taking longer than configured allowed time."),
